...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#non_blocking_alert{margin:0;padding:0;position:fixed;width:320px;min-height:257px;background:#ff7020;right:20px;top:20px;z-index:9999999}#non_blocking_alert.more{min-height:373px}#non_blocking_alert__title{font-family:Inter;font-weight:600;line-height:29px;letter-spacing:0;position:relative;margin-top:30px;margin-left:24px;padding:0;color:#cc4900}#non_blocking_alert__content{margin-top:24px;margin-left:24px;font-family:Inter;font-size:20px;font-weight:700;line-height:24px;letter-spacing:0;text-align:left}#non_blocking_alert__content p{margin:0;padding:0}#non_blocking_alert__content p:first-of-type{color:rgba(255,255,255,.6196078431)}#non_blocking_alert__content p:not(:first-of-type){color:#fff}#non_blocking_alert__button_container{display:flex;gap:6px}#non_blocking_alert__button_container__quit{background:#fff;width:133px;height:30px;margin-top:32px;margin-left:24px;padding:9px 24px;border-radius:38px;border:none;cursor:pointer;font-family:Inter;font-size:12px;font-weight:400;line-height:19px;letter-spacing:0;color:#000;display:flex;align-items:center;justify-content:center}#non_blocking_alert__button_container__more{color:#fff;width:133px;height:30px;margin-top:32px;padding:9px 24px;border-radius:38px;border:2px solid #fff;background:rgba(0,0,0,0);cursor:pointer;font-family:Inter;font-size:12px;font-weight:400;line-height:19px;letter-spacing:0;display:flex;align-items:center;justify-content:center}#non_blocking_alert__more_phrase{margin-top:34px;margin-left:24px;font-family:Inter;font-size:16px;font-weight:400;line-height:19px;letter-spacing:0em;color:#fff}#non_blocking_alert__more_line{width:272px;margin-top:24px;margin-left:12px;border:1px solid #cc4900}#non_blocking_alert__more_input{margin:0;padding:0;width:272px;height:30px;margin-top:14px;margin-left:24px;border-radius:38px;background:rgba(0,0,0,0);border:2px solid #fff;text-align:center;font-size:16px;color:#fff}#non_blocking_alert__more_input:focus{outline:none}#non_blocking_alert__more_go_back{margin-top:32px;font-family:Inter;font-size:16px;font-weight:400;line-height:19px;letter-spacing:0em;color:rgba(255,255,255,.625)}#non_blocking_alert__more_go_back_btn{cursor:pointer;position:relative;width:272px;height:30px;margin-top:16px;border-radius:38px;border:none}`, ""]);
// Exports
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Inter:slnt,wght@-10..0,100..900&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#final_alert_container{width:675px;min-height:256px;background-color:#ff7020;position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);z-index:999999;display:flex;flex-direction:column;align-items:center}#final_alert_container__title{font-family:Inter;font-size:16px;font-weight:600;line-height:19px;letter-spacing:0em;text-align:left;margin-top:30px;padding:0;color:#cc4900}#final_alert_container__line{margin-top:24px;width:525px;text-align:center;font-family:Inter;font-size:20px;font-weight:700;line-height:24px;letter-spacing:0em;color:#fff}#final_alert_container__activity{font-family:Inter;font-size:13px;font-weight:400;line-height:16px;letter-spacing:0em;text-align:center;margin-top:14px;color:#fff}#final_alert_container__button{background:#fff;margin-top:29px;padding:7.5px 37px;border-radius:38px;border:none;cursor:pointer;font-family:Inter;font-size:12px;font-weight:400;line-height:19px;letter-spacing:0;color:#000;display:flex;align-items:center;justify-content:center}`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function Alert_Alert({ updateViolations }) {
    ...
    return ((0,jsx_runtime.jsxs)("div", Object.assign({ id: "non_blocking_alert", className: isMore ? "more" : "" }, { children: [(0,jsx_runtime.jsx)("h1", Object.assign({ id: "non_blocking_alert__title" }, { children: "Recenter" })), (0,jsx_runtime.jsxs)("div", Object.assign({ id: "non_blocking_alert__content" }, { children: [(0,jsx_runtime.jsx)("p", { children: "Feeling Distracted?" }), (0,jsx_runtime.jsx)("p", { children: "Let's Get Back to Work." }), (0,jsx_runtime.jsx)("p", { children: "You got this!" })] })), !isMore ? ((0,jsx_runtime.jsxs)("div", Object.assign({ id: "non_blocking_alert__button_container" }, { children: [(0,jsx_runtime.jsx)("button", Object.assign({ id: "non_blocking_alert__button_container__quit", onClick: onClose }, { children: "Let's Go!" })), (0,jsx_runtime.jsx)("button", Object.assign({ id: "non_blocking_alert__button_container__more", onClick: onMore }, { children: "Maybe Later" })), " "] }))) : ((0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("div", Object.assign({ id: "non_blocking_alert__more_phrase" }, { children: "Type the phrase \u201CMaybe Later\u201D to confirm" })), (0,jsx_runtime.jsx)("input", { id: "non_blocking_alert__more_input", onChange: handleViolation }), (0,jsx_runtime.jsx)("div", { id: "non_blocking_alert__more_line" }), (0,jsx_runtime.jsx)("div", Object.assign({ id: "non_blocking_alert__more_go_back" }, { children: "You can still get Back to Work" })), (0,jsx_runtime.jsx)("button", Object.assign({ id: "non_blocking_alert__more_go_back_btn", onClick: onClose }, { children: "Let's Go!" }))] }))] })));
}
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/utils/DOM_SCRIPTS/FinalAlert.scss
var FinalAlert = __webpack_require__(7300);
;// CONCATENATED MODULE: ./src/utils/DOM_SCRIPTS/FinalAlert.scss
...
var FinalAlert_options = {};

FinalAlert_options.styleTagTransform = (styleTagTransform_default());
FinalAlert_options.setAttributes = (setAttributesWithoutAttributes_default());

      FinalAlert_options.insert = insertBySelector_default().bind(null, "head");
    
FinalAlert_options.domAPI = (styleDomAPI_default());
FinalAlert_options.insertStyleElement = (insertStyleElement_default());

var FinalAlert_update = injectStylesIntoStyleTag_default()(FinalAlert/* default */.c, FinalAlert_options);




       /* harmony default export */ const DOM_SCRIPTS_FinalAlert = (FinalAlert/* default */.c && FinalAlert/* default */.c.locals ? FinalAlert/* default */.c.locals : undefined);

;// CONCATENATED MODULE: ./src/utils/DOM_SCRIPTS/FinalAlert.tsx
...
function FinalAlert_FinalAlert({ line }) {
    ...
    return ((0,jsx_runtime.jsxs)("div", Object.assign({ id: "final_alert_container" }, { children: [(0,jsx_runtime.jsx)("div", Object.assign({ id: "final_alert_container__title" }, { children: "Recenter" })), (0,jsx_runtime.jsx)("div", Object.assign({ id: "final_alert_container__line" }, { children: line })), (0,jsx_runtime.jsx)("div", Object.assign({ id: "final_alert_container__activity" }, { children: "Here is a quick activity to get you back to focus. Step away from the computer and try 5 pushups." })), (0,jsx_runtime.jsx)("button", Object.assign({ id: "final_alert_container__button", onClick: onClose }, { children: "Let's Go!" }))] })));
}
function insertFinalAlert(line) {
    ...
    document.body.appendChild(root);
    const rootDiv = client.createRoot(root);
    rootDiv.render((0,jsx_runtime.jsx)(react.StrictMode, { children: (0,jsx_runtime.jsx)(FinalAlert_FinalAlert, { line: line }) }));
}
...
class WebActivity {
    ...
    keepTrack() {
        chrome.storage.local.get(["dailyTime"], (data) => WebActivity_awaiter(this, void 0, void 0, function* () {
...
;// CONCATENATED MODULE: ./src/ContentWebTime.ts
var ContentWebTime_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class ContentWebTime {
    ...
    storeWeeklyTime() {
        var _a;
        return ContentWebTime_awaiter(this, void 0, void 0, function* () {
            ...
            let oldTime = (((_a = (yield chrome.storage.local.get("weeklyTime"))) === null || _a === void 0 ? void 0 : _a.weeklyTime) || []).filter((e) => e.url !== "");
            for (let i = 0; i < oldTime.length; i++) {
                if (oldTime[i].url === document.location.origin) {
                    oldTime[i].time += this.getTimeSpent();
                    yield chrome.storage.local.set({ weeklyTime: oldTime });
                    return;
                }
            }
    ...
    storeMonthlyTime() {
        ...
        return ContentWebTime_awaiter(this, void 0, void 0, function* () {
            ...
            let oldTime = (((_a = (yield chrome.storage.local.get("monthlyTime"))) === null || _a === void 0 ? void 0 : _a.monthlyTime) || []).filter((e) => e.url !== "");
            for (let i = 0; i < oldTime.length; i++) {
                if (oldTime[i].url === document.location.origin) {
                    oldTime[i].time += this.getTimeSpent();
                    yield chrome.storage.local.set({ monthlyTime: oldTime });
                    return;
                }
            }
            oldTime.push({ url: document.location.origin, time: this.getTimeSpent() });
    ...
    measureTime() {
        ...
        else if (!document.location.origin ||
    ...
    setNewDay() {
        return ContentWebTime_awaiter(this, void 0, void 0, function* () {
            ...
            if (numberOfDays === 0) {
                numberOfDays = 1;
                yield chrome.storage.local.set({ numberOfDays });
            }
